...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "output_pdf")
...
def main():
    ...
    plot_baseline_trajectory(baseline, os.path.join(OUTPUT_DIR, "baseline_trajectory.pdf"))
    plot_feedback_loop_dominance(baseline, os.path.join(OUTPUT_DIR, "feedback_loop_dominance.pdf"))
    print(f"\n  → Saved: baseline_trajectory.png, feedback_loop_dominance.pdf")
    ...
    plot_adversary_dynamics(baseline, os.path.join(OUTPUT_DIR, "adversary_dynamics.pdf"))
    print(f"\n  → Saved: adversary_dynamics.pdf")
    ...
    plot_strategy_comparison(strat_results,
                            os.path.join(OUTPUT_DIR, "strategy_comparison.pdf"))
    print(f"\n  → Saved: strategy_comparison.pdf")
    ...
    plot_monte_carlo_distributions(mc, os.path.join(OUTPUT_DIR, "monte_carlo_distributions.pdf"))
    ...
    plot_sensitivity_tornado(sobol_results,
                            os.path.join(OUTPUT_DIR, "sensitivity_tornado.pdf"))
    print(f"\n  → Saved: sensitivity_tornado.pdf")
    ...
    plot_copula_analysis(sweep, os.path.join(OUTPUT_DIR, "copula_analysis.pdf"))
    print(f"\n  → Saved: copula_analysis.pdf")
    ...
    plot_posterior_distributions(delphi,
                                os.path.join(OUTPUT_DIR, "posterior_distributions.pdf"))
    print(f"\n  → Saved: posterior_distributions.pdf")
    ...
    plot_validation_residuals(cv["proposed"],
                              os.path.join(OUTPUT_DIR, "residual_analysis.pdf"))
    print(f"\n  → Saved: residual_analysis.pdf")
